...
#pragma pack(pop)
	...
	const int ThreeAddrAddNCond = 0x4; //!< Add immediate to src2 if src1 is zero
	const int ThreeAddrEqual = 0x5; //!< Compare two registers for equality
	const int ThreeAddrNEqual = 0x6; //!< Compare two registers for inequality
	const int ThreeAddrLessThan = 0x7; //!< Compare two registers for less-than
	const int ThreeAddrLessThanE = 0x8; //!< Compare two registers for less-than-equal
	const int ThreeAddrGreaterThan = 0x9; //!< Compare two registers for greater-than
	const int ThreeAddrGreaterThanE = 0xa; //!< Compare two registers for greater-than-equal
	const int ThreeAddrOr = 0xb; //!< Boolean OR
